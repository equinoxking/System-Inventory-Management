        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center; border: none;" width="80%">
                    ...
                    <p style="margin: 0; font-size: 18px; font-weight:bold; margin-top:0.5rem;">
                        @if ($selection === 'All' && $division === null)
                            All Transaction Records
                        @elseif($selection !== 'All' && $selection !== null)
                            Transaction Records of {{ $client->full_name }}
                        @elseif($selection === null)
                            Transaction Records of {{ ucwords($division) }}
                        @endif
                    </p>
                </td>
                <th style="border: none;">
